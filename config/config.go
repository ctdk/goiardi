...
type Options struct {
	...
	UseSSL         bool   `long:"use-ssl" description:"Use SSL for connections. If --port is set to 443, this will automatically be turned on. If it is set to 80, it will automatically be turned off. Default: off. Requires --ssl-cert and --ssl-key." env:"GOIARDI_USE_SSL"`
