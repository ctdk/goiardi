...
func TestDepsolverEmptyRunList(t *testing.T) {
	...
	resp, err = client.PostOrg("/environments/"+envName+"/cookbook_versions", payload)
	if err != nil {
		t.Fatalf("POST /environments/%s/cookbook_versions: %v", envName, err)
	}
...
func TestDepsolverNonExistentCookbookDefaultEnv(t *testing.T) {
	...
	resp, err := client.PostOrg("/environments/_default/cookbook_versions", payload)
	if err != nil {
...
func TestDepsolverExistingCookbook(t *testing.T) {
	...
	resp, err = client.PostOrg("/environments/"+envName+"/cookbook_versions", depsPayload)
	if err != nil {
		t.Fatalf("POST /environments/%s/cookbook_versions: %v", envName, err)
	}
	pedant.AssertStatus(t, resp, 200)
...
func TestDepsolverExistingCookbookDefaultEnv(t *testing.T) {
	...
	resp, err = client.PostOrg("/environments/_default/cookbook_versions", depsPayload)
	if err != nil {
		t.Fatalf("POST /environments/_default/cookbook_versions: %v", err)
	}
	pedant.AssertStatus(t, resp, 200)
...
func TestDepsolverInvalidEnvironment(t *testing.T) {
	...
	resp, err := client.PostOrg("/environments/not@environment/cookbook_versions", depsPayload)
	if err != nil {
...
func TestDepsolverWithDependencies(t *testing.T) {
	...
	// bar depends on foo
	payloadFoo := pedant.NewCookbook(cbFoo, "1.0.0")
	payloadBar := pedant.NewCookbook(cbBar, "2.0.0", map[string]interface{}{
	...
	defer func() {
		client.DeleteOrg("/cookbooks/" + cbFoo + "/1.0.0")
		client.DeleteOrg("/cookbooks/" + cbBar + "/2.0.0")
	}()

	resp, err := client.PutOrg("/cookbooks/"+cbFoo+"/1.0.0", payloadFoo)
	if err != nil {
		t.Fatalf("PUT /cookbooks/%s/1.0.0: %v", cbFoo, err)
	}
	pedant.AssertStatus(t, resp, 201)

	resp, err = client.PutOrg("/cookbooks/"+cbBar+"/2.0.0", payloadBar)
	if err != nil {
...
func TestDepsolverMissingDependency(t *testing.T) {
	...
	payload := pedant.NewCookbook(cbName, "1.2.3", map[string]interface{}{
		"metadata": map[string]interface{}{
			"version":      "1.2.3",
			"name":         cbName,
	...
	defer client.DeleteOrg("/cookbooks/" + cbName + "/1.2.3")

	resp, err := client.PutOrg("/cookbooks/"+cbName+"/1.2.3", payload)
	if err != nil {
...
func TestDepsolverImpossibleDependency(t *testing.T) {
	...
	payloadFoo := pedant.NewCookbook(cbFoo, "1.2.3", map[string]interface{}{
		"metadata": map[string]interface{}{
			"version":      "1.2.3",
			"name":         cbFoo,
	...
	defer func() {
		client.DeleteOrg("/cookbooks/" + cbFoo + "/1.2.3")
		client.DeleteOrg("/cookbooks/" + cbBar + "/2.0.0")
	}()

	resp, err := client.PutOrg("/cookbooks/"+cbFoo+"/1.2.3", payloadFoo)
	if err != nil {
